...
/// <summary>
/// Unit tests for <see cref="PromptWindowTiler.TilePromptWindows"/> — the pure geometry that turns
...
public class PromptRelayTilingTests
{
    ...
    {
        Assert.Empty(PromptWindowTiler.TilePromptWindows([], clipSeconds: 4));
    }

    [Fact]
    public void Single_mid_clip_window_yields_leading_and_trailing_gaps()
    {
        var tiled = PromptWindowTiler.TilePromptWindows(
