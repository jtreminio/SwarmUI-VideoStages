...
public sealed class ArchitectureContractGraphTests
{
    ...
    /// </summary>
    private abstract class MixedArchitectureFixture(IReadOnlyList<string> modelFixturePaths)
    ...
    private sealed class LtxAndWanFixture() : MixedArchitectureFixture(
    ...
    private sealed class LtxAndMiniMaxFixture() : MixedArchitectureFixture(
