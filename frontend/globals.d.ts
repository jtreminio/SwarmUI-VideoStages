...
declare let doToggleGroup: ((id: string) => void) & { __toggleableGroupReuseGuardWrapped?: boolean };
...
declare let copy_current_image_params: (() => void) & { __videoStagesWrapped?: boolean };
