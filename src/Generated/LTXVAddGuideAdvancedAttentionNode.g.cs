...
/// <summary>Adds a conditioning frame/video at a specific frame index with per-guide attention strength control. Same preprocessing as LTXVAddGuideAdvanced, plus attention_strength and optional spatial attention_mask.</summary>
/// <remarks>Category: conditioning/video_models</remarks>
public sealed class LTXVAddGuideAdvancedAttentionNode : ComfyNode
{
    /// <summary>ComfyUI <c>class_type</c> for this node — use for static refs (switch cases, <c>g.CreateNode(...)</c>).</summary>
    public const string ClassType = "LTXVAddGuideAdvancedAttention";
    ...
    public LTXVAddGuideAdvancedAttentionNode()
    {
