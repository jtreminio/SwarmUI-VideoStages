...
internal sealed class StageHostExecutionScope : IDisposable
{
        ...
        StagePlan plannedStage)
    {
        ...
        _generator.UserInput.Set(T2IParamTypes.VideoModel.Type, plannedStage.Core.Model, sectionId);
        _generator.UserInput.Set(T2IParamTypes.VideoSteps, plannedStage.Core.Steps, sectionId);
        _generator.UserInput.Set(T2IParamTypes.Steps, plannedStage.Core.Steps, sectionId);
        _generator.UserInput.Set(T2IParamTypes.VideoCFG, plannedStage.Core.CfgScale, sectionId);
        _generator.UserInput.Set(T2IParamTypes.CFGScale, plannedStage.Core.CfgScale, sectionId);
        _generator.UserInput.Set(
            ComfyUIBackendExtension.SamplerParam.Type,
            plannedStage.Core.Sampler,
            sectionId);
        _generator.UserInput.Set(
            ComfyUIBackendExtension.SchedulerParam.Type,
            plannedStage.Core.Scheduler,
            sectionId);
