...
internal sealed class StageUpscaleGraphBuilder(WorkflowGenerator g)
{
        ...
        LtxPostVideoChainCapture postVideoChain)
    {
        ...
        if (stage.Upscale.Mode == StageUpscaleMode.None
            || string.IsNullOrWhiteSpace(stage.Upscale.RawMethod))
        {
        ...
        if (isLtxv2Stage
            && stage.Upscale.Mode is StageUpscaleMode.LatentModel or StageUpscaleMode.Latent)
        {
            g.CurrentMedia = source;
            return source;
        }
