...
internal class StageRunner
{
    ...
    private readonly LtxManager _ltxManager;
    ...
    public StageRunner(WorkflowGenerator generator, LtxManager ltxManager)
    {
        _generator = generator ?? throw new ArgumentNullException(nameof(generator));
        _ltxManager = ltxManager ?? throw new ArgumentNullException(nameof(ltxManager));
    ...
    private void RunPassthroughStage(
        ...
        ClipContext clipContext)
    {
        _ltxManager.PrepareReusableAudio(clipContext, stage);
        LtxPostVideoChainCapture postVideoChain =
            _ltxManager.TryCapturePostVideoChain(clipContext, stage);
